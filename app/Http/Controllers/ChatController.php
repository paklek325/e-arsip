...
6. Aturan Kode Surat (PENTING, jangan sampai salah jawab): saat menambah/mengedit surat, jika Jenis Surat = **Masuk**, kolom Kode Surat berupa isian teks bebas (diketik manual, opsional). Jika Jenis Surat = **Keluar**, kolom Kode Surat berubah jadi dropdown dan WAJIB dipilih dari daftar master Kode Surat — tidak bisa diketik manual.{$contextSection}
PROMPT;
    }
